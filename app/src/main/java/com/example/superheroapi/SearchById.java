...
public class SearchById extends AppCompatActivity {
    ...
    TextView tvname,tvintelligence,tvstrenght,tvSpeed,tvdurability,
            ...
            tvGender,tvRace,tvHeight,tvWeight,tvEyeColor,tvHairColor;
                ...
                callFetchBiography.enqueue(new Callback<Biography>() {
                    ...
                    public void onResponse(Call<Biography> call, Response<Biography> response) {
                        if (response.isSuccessful()){
                            ...
                            tvFullName.setText("Full Name : " +biography.getFullName());
                            tvAlterEgos.setText("AlterEgos : " +biography.getAlterEgos());
                            tvAliases.setText("Aliases : " +biography.getAliases());
                            tvPlaceOfBirth.setText("Place of Birth : " +biography.getPlaceOfBirth());
                            tvFirstAppearance.setText("First Appearance : "+biography.getFirstAppearance());
